...
func GameModelToProto(gameModel *models.Game) *xylona.Game {
	return &xylona.Game{
		...
		LinuxBackupCommand:                gameModel.LinuxBackupCommand,
		LinuxRestoreCommand:               gameModel.LinuxRestoreCommand,
		LinuxWorkingDirectory:             gameModel.LinuxWorkingDirectory,
		LinuxConfigurationFilePaths:       gameModel.LinuxConfigurationFilePaths,
		...
		WindowsBackupCommand:              gameModel.WindowsBackupCommand,
		WindowsRestoreCommand:             gameModel.WindowsRestoreCommand,
		WindowsWorkingDirectory:           gameModel.WindowsWorkingDirectory,
		WindowsConfigurationFilePaths:     gameModel.WindowsConfigurationFilePaths,
...
func GameProtoToModel(gameProto *xylona.Game) *models.Game {
	return &models.Game{
		...
		LinuxBackupCommand:                gameProto.LinuxBackupCommand,
		LinuxRestoreCommand:               gameProto.LinuxRestoreCommand,
		LinuxWorkingDirectory:             gameProto.LinuxWorkingDirectory,
		LinuxConfigurationFilePaths:       gameProto.LinuxConfigurationFilePaths,
		LinuxAllowBackups:                 gameProto.LinuxAllowBackups,
		...
		WindowsBackupCommand:              gameProto.WindowsBackupCommand,
		WindowsRestoreCommand:             gameProto.WindowsRestoreCommand,
		WindowsWorkingDirectory:           gameProto.WindowsWorkingDirectory,
		WindowsConfigurationFilePaths:     gameProto.WindowsConfigurationFilePaths,
		WindowsAllowBackups:               gameProto.WindowsAllowBackups,
