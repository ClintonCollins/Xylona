...
var NotificationColumns = buildNotificationColumns("notification")
...
func (o *Notification) pkEQ() dialect.Expression {
	return sqlite.Quote("notification", "id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o NotificationSlice) pkIN() dialect.Expression {
	...
	return sqlite.Quote("notification", "id").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
