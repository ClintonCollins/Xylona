...
func (o *Migration) pkEQ() dialect.Expression {
	return sqlite.Quote("migrations", "id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o MigrationSlice) pkIN() dialect.Expression {
	...
	return sqlite.Quote("migrations", "id").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
