...
func buildRolePermissionColumns(alias string) rolePermissionColumns {
	return rolePermissionColumns{
		...
		).WithParent("role_permission"),
		tableAlias:   alias,
		RoleID:       sqlite.Quote(alias, "role_id"),
		PermissionID: sqlite.Quote(alias, "permission_id"),
	}
}
...
type rolePermissionColumns struct {
	...
	PermissionID sqlite.Expression
}
...
func (s *RolePermissionSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
		...
		if s.PermissionID.IsValue() {
			vals = append(vals, sqlite.Arg(s.PermissionID.MustGet()))
		}
...
func buildRolePermissionWhere[Q sqlite.Filterable](cols rolePermissionColumns) rolePermissionWhere[Q] {
	return rolePermissionWhere[Q]{
		...
		PermissionID: sqlite.Where[Q, string](cols.PermissionID),
	}
}
