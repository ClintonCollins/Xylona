...
var RolePermissions = sqlite.NewTablex[*RolePermission, RolePermissionSlice, *RolePermissionSetter]("", "role_permission", buildRolePermissionColumns("role_permission"))
