...
var RolePermissions = sqlite.NewTablex[*RolePermission, RolePermissionSlice, *RolePermissionSetter]("", "role_permission")
...
var RolePermissionColumns = buildRolePermissionColumns("role_permission")
...
func (s *RolePermissionSetter) Apply(q *dialect.InsertQuery) {
	...
	q.AppendValues(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
		...
		if !s.PermissionID.IsUnset() {
			vals = append(vals, sqlite.Arg(s.PermissionID))
		}
...
func (o *RolePermission) pkEQ() dialect.Expression {
	return sqlite.Group(sqlite.Quote("role_permission", "role_id"), sqlite.Quote("role_permission", "permission_id")).EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o RolePermissionSlice) pkIN() dialect.Expression {
	...
	return sqlite.Group(sqlite.Quote("role_permission", "role_id"), sqlite.Quote("role_permission", "permission_id")).In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o *RolePermission) Permission(mods ...bob.Mod[*dialect.SelectQuery]) PermissionsQuery {
	return Permissions.Query(append(mods,
		sm.Where(PermissionColumns.ID.EQ(sqlite.Arg(o.PermissionID))),
	)...)
}
...
func (os RolePermissionSlice) Permission(mods ...bob.Mod[*dialect.SelectQuery]) PermissionsQuery {
	...
	for i, o := range os {
		PKArgs[i] = sqlite.ArgGroup(o.PermissionID)
	}

	return Permissions.Query(append(mods,
		sm.Where(sqlite.Group(PermissionColumns.ID).In(PKArgs...)),
	)...)
}
...
func PreloadRolePermissionPermission(opts ...sqlite.PreloadOption) sqlite.Preloader {
	return sqlite.Preload[*Permission, PermissionSlice](orm.Relationship{
		Name: "Permission",
		Sides: []orm.RelSide{
			{
...
func ThenLoadRolePermissionPermission(queryMods ...bob.Mod[*dialect.SelectQuery]) sqlite.Loader {
...
func PreloadRolePermissionRole(opts ...sqlite.PreloadOption) sqlite.Preloader {
...
func ThenLoadRolePermissionRole(queryMods ...bob.Mod[*dialect.SelectQuery]) sqlite.Loader {
	return sqlite.Loader(func(ctx context.Context, exec bob.Executor, retrieved any) error {
		loader, isLoader := retrieved.(interface {
