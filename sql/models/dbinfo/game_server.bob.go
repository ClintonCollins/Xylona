...
var GameServers = Table[
	...
	Columns: gameServerColumns{
		...
		BaseCommandOverride: column{
			Name:      "base_command_override",
			DBType:    "TEXT",
			Default:   "''",
			Comment:   "",
			Nullable:  false,
