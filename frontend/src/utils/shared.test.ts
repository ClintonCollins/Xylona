...
describe('file type presentation', () => {
  it.each([
    ...
    ['server.bin', tabBinary, 'var(--xy-primary-hover)'],
    ['library.dylib', tabBinary, 'var(--xy-primary-hover)'],
    ['library.so', tabBinary, 'var(--xy-primary-hover)'],
    ['backup.tar.bz2', tabFileZip, 'var(--xy-purple)'],
    ['backup.tar.gz', tabFileZip, 'var(--xy-purple)'],
    ['backup.tar.xz', tabFileZip, 'var(--xy-purple)'],
    ['backup.tar.zst', tabFileZip, 'var(--xy-purple)'],
    ['backup.zip', tabFileTypeZip, 'var(--xy-purple)'],
    ['server.jar', tabArchive, 'var(--xy-purple)'],
    ['start.cmd', tabTerminal2, 'var(--xy-success)'],
    ['server.conf', tabFileSettings, 'var(--xy-warning)'],
    ['server.config', tabFileSettings, 'var(--xy-warning)'],
    ['.env', tabFileSettings, 'var(--xy-warning)'],
    ['server.properties', tabFileSettings, 'var(--xy-warning)'],
    ['server.settings', tabFileSettings, 'var(--xy-warning)'],
    ['server.toml', tabFileCode, 'var(--xy-accent)'],
    ['server.yaml', tabFileCode, 'var(--xy-accent)'],
    ['server.yml', tabFileCode, 'var(--xy-accent)'],
    ['server.json', tabJson, 'var(--xy-success)'],
    ['server.log', tabFilterSearch, 'var(--xy-text-muted)'],
    ['LICENSE', tabFileDescription, 'var(--xy-text-secondary)'],
    ['README', tabMarkdown, 'var(--xy-info)'],
    ['notes.markdown', tabMarkdown, 'var(--xy-info)'],
    ['notes.txt', tabFileTypeTxt, 'var(--xy-text-secondary)'],
    ['plugin.cjs', tabFileTypeJs, 'var(--xy-warning)'],
    ['plugin.js', tabFileTypeJs, 'var(--xy-warning)'],
    ['plugin.mjs', tabFileTypeJs, 'var(--xy-warning)'],
    ['plugin.ts', tabFileTypeTs, 'var(--xy-primary-hover)'],
    ['setup.py', tabFileCode, 'var(--xy-accent)'],
    ['schema.sql', tabFileTypeSql, 'var(--xy-accent)'],
    ['config.xml', tabFileTypeXml, 'var(--xy-accent)'],
    ['style.css', tabFileTypeCss, 'var(--xy-primary-hover)'],
    ['index.html', tabFileTypeHtml, 'var(--xy-accent)'],
    ['index.htm', tabFileTypeHtml, 'var(--xy-accent)'],
    ['JSON', tabJson, 'var(--xy-success)'],
    ['notes.txt.unknown', tabFileFilled, 'var(--xy-text-primary)'],
    ['unknown', tabFileFilled, 'var(--xy-text-primary)'],
    ['server.', tabFileFilled, 'var(--xy-text-primary)'],
    ['', tabFileFilled, 'var(--xy-text-primary)'],
  ])('maps %s to its icon and token color', (fileName, icon, color) => {
