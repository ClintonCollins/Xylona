<template>
    <q-dialog persistent v-model="showDialog" backdrop-filter="brightness(25%)">
        <q-card class="full-width">
            <q-card-section>
                <q-card-title>
                    <div class="text-h6">Rename {{ oldFileName }}</div>
                </q-card-title>
            </q-card-section>
            <q-card-section>
                <q-form class="q-pa-lg">
                    <div class="row wrap q-col-gutter-md justify-between">
                        <q-input name="newFileName" aria-autocomplete="none"
                                 class="col-12" outlined v-model="newFileName" label="New name" autofocus/>
                    </div>
                </q-form>
            </q-card-section>
