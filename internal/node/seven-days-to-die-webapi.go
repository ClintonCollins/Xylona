...
func (*Node) QuerySevenDaysToDieWebAPIStatus(ctx context.Context, req SevenDaysToDieWebAPIStatusQueryRequest) (*SevenDaysToDieWebAPIStatus, error) {
	...
	if bloodMoonAdvertised {
		errBloodMoon := querySevenDaysToDieBloodMoon(discovery.ctx, ctx, access, discovery.settings, status)
		if errBloodMoon != nil {
	...
	if serverStatsAdvertised {
		errServerStats := querySevenDaysToDieServerStats(discovery.ctx, ctx, access, discovery.settings, status)
...
func (*Node) QuerySevenDaysToDiePlayers(ctx context.Context, req SevenDaysToDiePlayersQueryRequest) (*SevenDaysToDiePlayers, error) {
	...
	state, body, errQuery := access.queryWebAPIResource(ctx, discovery, sevenDaysToDieWebAPIEndpointPlayer)
	if errQuery != nil {
...
func (*Node) QuerySevenDaysToDieReportedMods(ctx context.Context, req SevenDaysToDieReportedModsQueryRequest) (*SevenDaysToDieReportedMods, error) {
	...
	state, body, errQuery := access.queryWebAPIResource(ctx, discovery, sevenDaysToDieWebAPIEndpointMods)
	if errQuery != nil {
...
func (*Node) QuerySevenDaysToDieSandboxSettings(ctx context.Context, req SevenDaysToDieSandboxSettingsQueryRequest) (*SevenDaysToDieSandboxSettings, error) {
	...
	configuredValues, errConfig := access.serverSettings()
	if errConfig != nil {
		return result, nil
	}
	...
	state, body, errQuery := access.queryWebAPIResource(ctx, discovery, sevenDaysToDieWebAPIEndpointSandboxSettings)
	if errQuery != nil {
...
func querySevenDaysToDieBloodMoon(
	...
	statusCode, body, errQuery := access.getWebAPI(queryCtx, settings, sevenDaysToDieWebAPIEndpointBloodMoon)
	if errQuery != nil {
...
func querySevenDaysToDieServerStats(
	...
	statusCode, body, errQuery := access.getWebAPI(queryCtx, settings, sevenDaysToDieWebAPIEndpointServerStats)
	if errQuery != nil {
		errContext := callerCtx.Err()
		if errContext != nil {
