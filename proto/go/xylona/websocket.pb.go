...
type GameServerOutputRequest struct {
...
func (x *GameServerOutputRequest) Reset() {
	*x = GameServerOutputRequest{}
...
func (x *GameServerOutputRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameServerOutputRequest) ProtoMessage() {}

func (x *GameServerOutputRequest) ProtoReflect() protoreflect.Message {
	mi := &file_websocket_proto_msgTypes[0]
...
// Deprecated: Use GameServerOutputRequest.ProtoReflect.Descriptor instead.
func (*GameServerOutputRequest) Descriptor() ([]byte, []int) {
	return file_websocket_proto_rawDescGZIP(), []int{0}
}

func (x *GameServerOutputRequest) GetGameServerId() string {
	if x != nil {
...
var file_websocket_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a, 0x17, 0x47, 0x61,
	...
	0x61, 0x6d, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x64, 0x42, 0x32, 0x5a, 0x30, 0x67,
...
var file_websocket_proto_goTypes = []interface{}{
	(*GameServerOutputRequest)(nil), // 0: xylona.GameServerOutputRequest
}
...
func file_websocket_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_websocket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GameServerOutputRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
