...
const (
	...
	// XylonaExecuteGameServerOperationProcedure is the fully-qualified name of the Xylona's
	// ExecuteGameServerOperation RPC.
	XylonaExecuteGameServerOperationProcedure = "/xylona.Xylona/ExecuteGameServerOperation"
	...
	// XylonaInstallSevenDaysToDieLandClaimsModProcedure is the fully-qualified name of the Xylona's
	// InstallSevenDaysToDieLandClaimsMod RPC.
	XylonaInstallSevenDaysToDieLandClaimsModProcedure = "/xylona.Xylona/InstallSevenDaysToDieLandClaimsMod"
...
type XylonaClient interface {
	...
	ExecuteGameServerOperation(context.Context, *connect.Request[xylona.ExecuteGameServerOperationRequest]) (*connect.Response[xylona.ExecuteGameServerOperationResponse], error)
	...
	InstallSevenDaysToDieLandClaimsMod(context.Context, *connect.Request[xylona.InstallSevenDaysToDieLandClaimsModRequest]) (*connect.Response[xylona.InstallSevenDaysToDieLandClaimsModResponse], error)
...
func NewXylonaClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) XylonaClient {
	...
	return &xylonaClient{
		...
		executeGameServerOperation: connect.NewClient[xylona.ExecuteGameServerOperationRequest, xylona.ExecuteGameServerOperationResponse](
			httpClient,
			baseURL+XylonaExecuteGameServerOperationProcedure,
			connect.WithSchema(xylonaMethods.ByName("ExecuteGameServerOperation")),
			connect.WithClientOptions(opts...),
		),
		...
		installSevenDaysToDieLandClaimsMod: connect.NewClient[xylona.InstallSevenDaysToDieLandClaimsModRequest, xylona.InstallSevenDaysToDieLandClaimsModResponse](
			httpClient,
			baseURL+XylonaInstallSevenDaysToDieLandClaimsModProcedure,
			connect.WithSchema(xylonaMethods.ByName("InstallSevenDaysToDieLandClaimsMod")),
			connect.WithClientOptions(opts...),
		),
...
type xylonaClient struct {
	...
	executeGameServerOperation              *connect.Client[xylona.ExecuteGameServerOperationRequest, xylona.ExecuteGameServerOperationResponse]
	...
	installSevenDaysToDieLandClaimsMod      *connect.Client[xylona.InstallSevenDaysToDieLandClaimsModRequest, xylona.InstallSevenDaysToDieLandClaimsModResponse]
...
// ExecuteGameServerOperation calls xylona.Xylona.ExecuteGameServerOperation.
func (c *xylonaClient) ExecuteGameServerOperation(ctx context.Context, req *connect.Request[xylona.ExecuteGameServerOperationRequest]) (*connect.Response[xylona.ExecuteGameServerOperationResponse], error) {
	return c.executeGameServerOperation.CallUnary(ctx, req)
}
...
// InstallSevenDaysToDieLandClaimsMod calls xylona.Xylona.InstallSevenDaysToDieLandClaimsMod.
func (c *xylonaClient) InstallSevenDaysToDieLandClaimsMod(ctx context.Context, req *connect.Request[xylona.InstallSevenDaysToDieLandClaimsModRequest]) (*connect.Response[xylona.InstallSevenDaysToDieLandClaimsModResponse], error) {
	return c.installSevenDaysToDieLandClaimsMod.CallUnary(ctx, req)
}
...
func NewXylonaHandler(svc XylonaHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	xylonaExecuteGameServerOperationHandler := connect.NewUnaryHandler(
		XylonaExecuteGameServerOperationProcedure,
		svc.ExecuteGameServerOperation,
		connect.WithSchema(xylonaMethods.ByName("ExecuteGameServerOperation")),
		connect.WithHandlerOptions(opts...),
	)
	...
	xylonaInstallSevenDaysToDieLandClaimsModHandler := connect.NewUnaryHandler(
		XylonaInstallSevenDaysToDieLandClaimsModProcedure,
		svc.InstallSevenDaysToDieLandClaimsMod,
		connect.WithSchema(xylonaMethods.ByName("InstallSevenDaysToDieLandClaimsMod")),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/xylona.Xylona/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case XylonaExecuteGameServerOperationProcedure:
			xylonaExecuteGameServerOperationHandler.ServeHTTP(w, r)
		...
		case XylonaInstallSevenDaysToDieLandClaimsModProcedure:
			xylonaInstallSevenDaysToDieLandClaimsModHandler.ServeHTTP(w, r)
...
func (UnimplementedXylonaHandler) ExecuteGameServerOperation(context.Context, *connect.Request[xylona.ExecuteGameServerOperationRequest]) (*connect.Response[xylona.ExecuteGameServerOperationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xylona.Xylona.ExecuteGameServerOperation is not implemented"))
}
...
func (UnimplementedXylonaHandler) InstallSevenDaysToDieLandClaimsMod(context.Context, *connect.Request[xylona.InstallSevenDaysToDieLandClaimsModRequest]) (*connect.Response[xylona.InstallSevenDaysToDieLandClaimsModResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xylona.Xylona.InstallSevenDaysToDieLandClaimsMod is not implemented"))
}
